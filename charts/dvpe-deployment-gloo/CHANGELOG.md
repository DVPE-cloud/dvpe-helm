...
### Changed
* Secrets generation for new ExternalSecret

  Parameter changes:
  - removed `externalSecrets.service.roleArn` (not required anymore with new SecretStores per Namespace)
  - added `externalSecrets.service.secretstoreName` to set secretStore if required, default points to namespace secretStore generated by Crossplane Tenant XRD
...
[3.3.0]: https://github.com/DVPE-cloud/dvpe-helm/tree/dvpe-deployment-gloo-3.3.0/charts/dvpe-deployment-gloo
