...
| gloo.authConfig.spec.configs.authExtensionPlugin.config.enableUserRolesForwarding | bool | `false` | `enableUserRolesForwarding` is a flag which tells whether the user roles should be forwarded or not |
