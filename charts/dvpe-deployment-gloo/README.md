...
| gloo.ingress.scope | string | `"private"` | Signals Gloo which Gateway Proxy to use for deploying a Virtual Service into. Value must be one of `private` for intranet- or `public` for internet-deployment. |
