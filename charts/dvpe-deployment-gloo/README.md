...
Note that this chart assumes that [gloo Enterprise](https://docs.solo.io/gloo/latest/installation/enterprise/) has already been installed and configured on your K8S cluster.
...
* [gloo API Gateway Enterprise](https://docs.solo.io/gloo/latest/installation/enterprise/) has already been installed on the K8S cluster
* a namespace has already been created on the K8S cluster
